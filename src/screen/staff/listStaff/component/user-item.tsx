  ...
  return (
    <View
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.8}
        onPress={() => {
          item?.navigation?.navigate('addUser', {
            item,
          });
        }}>
        <View>
        ...
        <View>
          <Text style={style.textHead}>{item?.item?.fullName}</Text>
          <Text style={style.text}>{item?.item?.email}</Text>
          <Text style={style.text}>{item?.item?.phone}</Text>
        </View>
      </TouchableOpacity>
    </View>
  );
